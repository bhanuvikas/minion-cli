"""Atomic YAML rewrite helper for agent manifest files."""
...
def update_agent_yaml(path: Path, updates: dict[str, Any]) -> None:
    """Load the agent YAML, apply updates atomically, write back via .tmp rename.
